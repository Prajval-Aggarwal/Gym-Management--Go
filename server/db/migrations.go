...
func AutoMigrateDatabase(db *gorm.DB) {
	...
	if dbVersion.Version < 1 {
		err := db.AutoMigrate(&model.User{}, &model.GymEmp{}, &model.Payment{}, &model.Subscription{}, &model.SubsType{}, &model.Equipment{}, &model.UAttendence{}, &model.EmpAttendence{}, &model.EmpTypes{})
		if err != nil {
			panic(err)
		}
